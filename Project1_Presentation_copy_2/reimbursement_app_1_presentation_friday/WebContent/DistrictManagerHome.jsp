...
<head>
  <title>District Management TRMS</title>
  <!-- Required meta tags -->
  <meta charset="utf-8" />
    ...
    <h1 class="text-warning mr-5"> <%= initialGreeting.greeting() %> </h1>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="myNavbar">
        <ul class="navbar-nav links d-md-none">
          <li class="nav-item">
            <a class="nav-link " href="#">View/Edit Your Personal Account Information</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="#">View/Edit Your Pending/Completed Reimbursement Requests</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="districtManagementReimbursementControllerServlet">View All Reimbursement Requests in DataBase</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="districtManagementEmployeeControllerServlet">View All Employees in Database</a>
          </li>
        </ul>
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-lg-10 py-5 bg-light">
        ...
        <div class="row mb-5">
          <div class="col">
            <h3>
              <span class="text-uppercase text-danger">District Manager Dashboard /</span><span class="text-muted small"> My
                Dashboard</span>
            </h3>
          </div>
        </div>
