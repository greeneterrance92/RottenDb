...
<body>
	...
	<div id="container">
		...
		<input type="button" value="+Reimbursement"
			onclick="window.location.href='add-reimbursement-form3.jsp'; return false;"
		...
		<!--  add remibursement button-->
			...
			<table>
				...
				<c:forEach var="tempReimbursement" items="${REIMBURSEMENTS_LIST}">
					...
					<c:url var="tempLink" value="ReimbursementControllerServlet3">
						...
						<c:url var="deleteLink" value="ReimbursementControllerServlet3">
