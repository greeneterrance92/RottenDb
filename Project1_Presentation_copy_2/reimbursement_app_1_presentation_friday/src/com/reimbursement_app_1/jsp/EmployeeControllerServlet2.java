 ...
 */
@WebServlet("/EmployeeControllerServlet2")
public class EmployeeControllerServlet2 extends HttpServlet {
	...
	private void loadEmployee(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/update-employee-form2.jsp");
	...
	private void listEmployees(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/list-employees2.jsp");
		dispatcher.forward(request, response);
